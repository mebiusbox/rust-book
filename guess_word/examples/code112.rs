...
// このguess_word_guiモジュールは、ここまでの src/gui.rs の内容になっています
mod guess_word_gui {
    use crate::guess_word_lib::*; // src/gui.rs の場合は use guess_word::*
...
use crate::guess_word_gui::GuessWord;   // src/gui.rs の場合は mod gui;
